...
class bloqueraRepository {
    ...
    async update(base, dias_sucios, extra_m3) {
     ...
     WHERE COLABORADOR.CB_NIVEL5 = 'CMX' AND APP_NIVEL2.TB_ELEMENT = 'Bloqueras' AND COLABORADOR.CB_ACTIVO = 'S'
      `;
     try {
 ...
 async indicator(year, valorReal){
    ...
    const queryString = `SELECT 
                        ...
                        FROM DatoReporte 
                        WHERE IndicadorID = 16 and EntidadID = 15 and Periodo = ${year}`;
    try {
