...
class CorteRepository {
    ...
    async findTeam() {
        ...
        const queryString = `
        SELECT 
            COLABORADOR.CB_CODIGO AS userID, 
            COLABORADOR.CB_NOMBRES AS nombre, 
            COLABORADOR.CB_APE_PAT AS a_paterno,
            COLABORADOR.CB_APE_MAT AS a_materno,
            COLABORADOR.CB_SEXO AS sexo, 
            COLABORADOR.CB_TEL AS telefono,
            COLABORADOR.CB_E_MAIL AS email,
            turno.[TU_CODIGO] as turno,
            turno.[TU_DIAS] as dias, 
            turno.[TU_VACA_HA] as factor,
        ...
        JOIN APP_TURNO turno ON turno.TU_CODIGO = COLABORADOR.CB_TURNO
