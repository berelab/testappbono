...
class McsframeRepository {
    ...
    async findTeam() {
        ...
        WHERE COLABORADOR.CB_NIVEL5 = 'JRZ' AND COLABORADOR.CB_ACTIVO = 'S' AND APP_NIVEL2.TB_ELEMENT = 'Mcs frame'
        `;
        try {
    ...
    async findProdDepto() {
        ...
        let pool;
        const queryString = `
        SELECT TOP (8) * FROM produccion_deptos where depto = 'Mcs Frame' and city='Juarez' order by id DESC
        `;
    ...
    async findBonosDepto() {
        ...
        let pool;
        const queryString = `
        SELECT TOP (8) * FROM bonos_deptos where depto = 'Mcs Frame' and city='Juarez' order by id DESC
        `;
