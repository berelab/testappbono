...
import choferModel from '../../models/hermosillo/choferesModel';
import choferSQL from '../../infrastructure/hermosillo/choferRepo';
...
const controller = {
	...
	home: async(req, res) => {
		...
		return res.status(200).send({
            ...
            num_quejas_cliente: chofer.num_quejas_cliente,
            dias: chofer.dias, 
