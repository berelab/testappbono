...
import bloqueraModel from '../../models/villahermosa/preexpMoldeoModel';
import bloqueraSQL from '../../infrastructure/villahermosa/bloqueraRepo';
import mainCalcs from '../MainCalcs';
import convertData from '../ConvertData';
import att from '../Attendance';
import oracleProduccionRepo from '../../infrastructure/villahermosa/produccionRepository';
...
const controller = {
    ...
    home: async(req, res) =>{
        ...
        return res.status(200).send({
            ...
            dias_sucios: bloquera.auditoria_sol,
    ...
    calculator: async(req, res)=>{
        ...
        const calc = new mainCalcs(
            ...
            bloquera.base0, 
            bloquera.$_extra_m3, 
            bloquera.auditoria_sol, 
            bloquera.factor_dias_laborados,
            bloquera.message,
            bloquera.city,
            bloquera.amp,
            bloquera.blocks_fe,
            bloquera.ltkg_preexpandido,
            null,
            null,
