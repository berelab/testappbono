...
import {message, city, dias, asistencia_total, m2_producidos, retardos_entrega, falla_calidad, asistencias, equipo} from '../../models/guadalajara/insulpanelModel'
        ...
        if(req.params.index){
            ...
            if(i < 0 || i >= len ){
                ...
                return res.status(200).send({
                    ...
                    nivel_del_Plan_de_Carrera: equipo[i].nivel_dPdC,
                    depto: message,
                    day: weekdayName,
                    pago: bono_total[i],
