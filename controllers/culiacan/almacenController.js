...
const controller ={
    ...
    calculator: async(req, res)=>{
        ...
        for(var i =0; i<len; i++){
            var total = ((almacen.horas_extras_semana[i].horas_extras.horas_extras_dobles*2) +  (almacen.horas_extras_semana[i].horas_extras.horas_extras_triples*3))/24;
        ...
        const calc = new mainCalcs(
            ...
            almacen.message,
            almacen.city,
            almacen.errores_carga,
            almacen.uso_equipo_seguridad,
            null,
            null,
