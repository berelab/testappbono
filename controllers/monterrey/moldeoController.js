...
import {message, city, base0, dias_sucios, num_quejas, dias, factor_dias_laborados, asistencia_total, $_extra_m3, m3_cortados, colaboradores, equipo, horas_extras_semana} from '../../models/monterrey/moldeoModel';
...
const controller ={
    ...
    calculator: (req, res)=>{
        ...
        for(var i =0; i<len; i++){
            var total = ((horas_extras_semana[i].horas_extras.horas_extras_dobles*2) +  (horas_extras_semana[i].horas_extras.horas_extras_triples*3))/12;
