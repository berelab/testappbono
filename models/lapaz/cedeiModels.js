...
class CediModels {
    ...
    async _produccion (day){
        ...
        if(day == 1){
            ...
            let produccionL = await this.produccionRepo.findCedi(fechaL, fechaLf); //para obtener la produccion se ocupa un intervalo la fecha del dia actual y la del dia siguiente
            ...
            let produccionL = await this.produccionRepo.findCedi(fechaL, fechaMa);
            let totalL= this._convertProd(produccionL.rows)
            m3cortados.lunes = totalL

            let produccionMa = await this.produccionRepo.findCedi(fechaMa, fechaMi);
            ...
            let produccionMi = await this.produccionRepo.findCedi(fechaMi, fechaJ);
            ...
            let produccionJ = await this.produccionRepo.findCedi(fechaJ, fechaV);
            ...
            let produccionV = await this.produccionRepo.findCedi(fechaV, fechaS);
