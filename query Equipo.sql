...
-- QUERY LOGIN
SELECT 
	[FAN_BONO].[dbo].[APP_COLABORA].[CB_NOMBRES], 
	[FAN_BONO].[dbo].[APP_COLABORA].[CB_APE_PAT],
	[FAN_BONO].[dbo].[APP_COLABORA].[CB_APE_MAT],
	[FAN_BONO].[dbo].[APP_COLABORA].[CB_CODIGO],
	[FAN_BONO].[dbo].[APP_COLABORA].[CB_PUESTO],
	[FAN_BONO].[dbo].[APP_COLABORA].[CB_G_TEX_4],
	[FAN_BONO].[dbo].[APP_COLABORA].[CB_ACTIVO],
	[FAN_BONO].[dbo].[APP_NIVEL2].[TB_ELEMENT],
	[FAN_BONO].[dbo].[APP_COLABORA].[CB_NIVEL2],
	[FAN_BONO].[dbo].[APP_COLABORA].[CB_NIVEL5]
...
WHERE [FAN_BONO].[dbo].[APP_COLABORA].[CB_ACTIVO] = 'S'

ORDER BY  [FAN_BONO].[dbo].[APP_COLABORA].[CB_NIVEL5] , [FAN_BONO].[dbo].[APP_NIVEL2].[TB_ELEMENT] 